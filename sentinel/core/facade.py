...
class CoreServicesFacade:
    ...
    def __init__(
        ...
        logger.debug("CoreServicesFacade initialized.")
    ...
    def start(self, exchanges: list[str]):
        ...
        logger.info("Core services started for exchanges: %s", exchanges)
    ...
    async def start_async(self, exchanges: list[str]):
        ...
        logger.debug("Core services started asynchronously for exchanges: %s", exchanges)
    ...
    def subscribe_to_candles(self, exchange: str, symbol: str, timeframe: str, widget_instance: object):
        ...
        logger.debug("Subscription candles %s/%s/%s for widget %s", exchange, symbol, timeframe, id(widget_instance))
    ...
    def subscribe_to_trades(self, exchange: str, symbol: str, widget_instance: object):
        ...
        self.task_manager.subscribe(widget_instance, requirements)
        logger.debug("Subscription trades %s/%s for widget %s", exchange, symbol, id(widget_instance))
    ...
    def subscribe_to_orderbook(self, exchange: str, symbol: str, widget_instance: object):
        ...
        self.task_manager.subscribe(widget_instance, requirements)
        logger.debug("Subscription orderbook %s/%s for widget %s", exchange, symbol, id(widget_instance))
    ...
    def subscribe_to_ticker(self, exchange: str, symbol: str, widget_instance: object):
        ...
        self.task_manager.subscribe(widget_instance, requirements)
        logger.debug("Subscription ticker %s/%s for widget %s", exchange, symbol, id(widget_instance))
    ...
    async def aclose(self):
        ...
        logger.debug("CoreServicesFacade async cleanup initiated.")
        await self.task_manager.aclose()
        logger.debug("CoreServicesFacade async cleanup complete.")
